...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('•sᴇᴛᴛɪɴɢs•', callback_data='source')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            hmm = await message.reply_photo(photo='https://te.legra.ph/file/471172796da37b50f4f4f.jpg', caption=cap, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(9999)            
        except Exception as e:
            logger.exception(e)
...
async def advantage_spell_chok(msg):
    ...
    btn.append([InlineKeyboardButton(text="𝘊𝘭𝘰𝘴𝘦", callback_data=f'spolling#{user}#close_spellcheck')])
    await msg.reply("<b><i>I couldn't find anything related to that\nDid you mean any one of these?</i></b>",
                    reply_markup=InlineKeyboardMarkup(btn))
